...
[CustomEditor(typeof(FailureThroughRecover))]
public class EditorForFailureThroughRecover : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (_ExplainFolder)
        {
            EditorGUILayout.HelpBox(
                "TriggerEventコンポーネントと組み合わせ、障害物回避に失敗したオブジェクトを復帰させるコンポーネント\n" +
                ...
                "SetPositionは復帰後の位置をアサインするが、BeltScrollする CinemachineDollyCartにおけるpositionを示す\n" +
                "ObjectActivateは復帰対象オブジェクトの SetActive(true)を定義する"
